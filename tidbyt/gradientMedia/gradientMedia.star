        ...
        child = render.Stack(
            children = [
                ...
                render.Column(
                    children = [
                        render.Box(
                            width = 50,  # Adjust width for the first row
                            height = 10,  # Adjust height for the first row
                            color = "#FF0000"  # Example: Red for the first row
                        ),
                        render.Row(
                            children = [
                                render.Box(
                                    width = 20,  # First box in the row
                                    height = 10,
                                    color = "#FFFF00"  # Yellow box
                                ),
                                render.Box(
                                    width = 20,  # Cyan box containing the image
                                    height = 10,
                                    child = render.Image(
                                        width = 20,
                                        height = 10,
                                ...
                                render.Box(
                                    width = 10,  # Third box in the row
                                    height = 10,
                                    color = "#FF00FF"  # Magenta box
                                ),
                            ],
                        ),
                        render.Box(
                            width = 50,
                            height = 10,
                            color = "#0000FF"  # Example: Blue for the third row
                        ),
                    ],
                ),
            ]
